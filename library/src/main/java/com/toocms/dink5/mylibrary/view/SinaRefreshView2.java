...
public class SinaRefreshView2 extends FrameLayout implements IHeaderView {
    private ImageView refreshArrow;
    private ImageView loadingView;
    private TextView refreshTextView;

    public SinaRefreshView2(Context context) {
        this(context, null);
    }

    public SinaRefreshView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SinaRefreshView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        View rootView = View.inflate(getContext(), R.layout.load_refresh, null);
    ...
    public void onPullReleasing(float fraction, float maxHeadHeight, float headHeight) {
        if (fraction < 1f) {
            ...
            refreshArrow.setRotation(1-fraction * headHeight / maxHeadHeight * 180);
