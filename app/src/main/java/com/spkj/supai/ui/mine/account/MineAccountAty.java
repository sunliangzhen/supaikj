...
public class MineAccountAty extends BasAty {
    ...
    public int getLayoutId() {
        return R.layout.aty_mine_account;
    }
    ...
    public void initView() {
        sortFlagWidth = AutoUtils.getPercentWidthSize(124);
        ...
        mNewsFragmentList.add(AccountDetailsFrg.newInstance("1"));
        mNewsFragmentList.add(AccountDetailsFrg.newInstance("2"));
