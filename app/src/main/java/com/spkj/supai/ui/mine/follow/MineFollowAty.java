package com.spkj.supai.ui.mine.follow;
...
public class MineFollowAty extends BasAty {
    ...
    public int getLayoutId() {
        return R.layout.aty_mine_follow;
    }
    ...
    public class GoldRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = inflater.inflate(R.layout.item_mine_follow, parent, false);
