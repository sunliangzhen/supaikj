...
public class CpDetailsFrg extends BaseFragment {
    ...
    public static CpDetailsFrg newInstance(String city) {
        Bundle args = new Bundle();
        args.putString("city", city);
        CpDetailsFrg pageFragment = new CpDetailsFrg();
    ...
    public class GoldRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = inflater.inflate(R.layout.item_mine_cp_details, parent, false);
