...
public class MineEntrustAty extends BasAty {
    ...
    public int getLayoutId() {
        return R.layout.aty_mine_entrust;
    }
    ...
    public class GoldRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = inflater.inflate(R.layout.item_mine_entrust, parent, false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(EntrustDetailsAty.class, bundle);
                }
            });
        }
