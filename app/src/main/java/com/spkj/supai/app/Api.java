...
/*
   1. noCache 不使用缓存，全部走网络
    ...
    private Api(int hostType) {
        ...
        //缓存
        File cacheFile = new File(WeApplication.getAppContext().getCacheDir(), "cache");
...
//                .addInterceptor(mRewriteCacheControlInterceptor)
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(WeApplication.getAppContext()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
